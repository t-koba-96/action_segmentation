...
def main():
     ...
     if SETTING.model == 'Twostream_TCN':
         ...
         train.model_train(trainloader,testloader,net,criterion,optimizer,device,SETTING.epoch,SETTING.save_file,two_stream=True)
         ...
         net = net.to(device)
         optimizer=optim.Adam(net.parameters(),lr=SETTING.learning_rate,betas=(SETTING.beta1,0.999))
         train.model_train(trainloader,testloader,net,criterion,optimizer,device,SETTING.epoch,SETTING.save_file,cutout_img=True)
         ...
         net = net.to(device)
         optimizer=optim.Adam(net.parameters(),lr=SETTING.learning_rate,betas=(SETTING.beta1,0.999))
         train.model_train(trainloader,testloader,net,criterion,optimizer,device,SETTING.epoch,SETTING.save_file,posemap=True)
         ...
         net = net.to(device)
         optimizer=optim.Adam(net.parameters(),lr=SETTING.learning_rate,betas=(SETTING.beta1,0.999))
         train.model_train(trainloader,testloader,net,criterion,optimizer,device,SETTING.epoch,SETTING.save_file)
